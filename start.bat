...
start "Strategy" cmd /c "cd /d F:\aistock\services\strategy-engine && uvicorn src.main:app --host 0.0.0.0 --port 8002 --reload"
...
echo [3/5] Starting Go execution engine...
start "ExecutionEngine" cmd /c "cd /d F:\aistock\services\execution-engine && go run cmd/server/main.go"
